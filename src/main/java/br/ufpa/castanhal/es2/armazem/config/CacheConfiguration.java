package br.ufpa.castanhal.es2.armazem.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, br.ufpa.castanhal.es2.armazem.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, br.ufpa.castanhal.es2.armazem.repository.UserRepository.USERS_BY_EMAIL_CACHE);
