...
type ProdutoFormGroupContent = {
  ...
  nomeProduto: FormControl<IProduto['nomeProduto']>;
  altura: FormControl<IProduto['altura']>;
  largura: FormControl<IProduto['largura']>;
  comprimento: FormControl<IProduto['comprimento']>;
  codigoDeBarra: FormControl<IProduto['codigoDeBarra']>;
  tipoDeProduto: FormControl<IProduto['tipoDeProduto']>;
  validade: FormControl<IProduto['validade']>;
  produtoCadastrado: FormControl<IProduto['produtoCadastrado']>;
};
...
export class ProdutoFormService {
  createProdutoFormGroup(produto: ProdutoFormGroupInput = { id: null }): ProdutoFormGroup {
    ...
    return new FormGroup<ProdutoFormGroupContent>({
      ...
      nomeProduto: new FormControl(produtoRawValue.nomeProduto),
      altura: new FormControl(produtoRawValue.altura),
      largura: new FormControl(produtoRawValue.largura),
      comprimento: new FormControl(produtoRawValue.comprimento),
      codigoDeBarra: new FormControl(produtoRawValue.codigoDeBarra),
      tipoDeProduto: new FormControl(produtoRawValue.tipoDeProduto),
      validade: new FormControl(produtoRawValue.validade),
      produtoCadastrado: new FormControl(produtoRawValue.produtoCadastrado),
    });
  }
